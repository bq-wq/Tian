...
<body>
	...
	<div class="center_con clearfix">
		...
		<script type="text/javascript">
			$("#alltype").load("${pageContext.request.contextPath}/goodstype/selectall");
		</script>
		<%--<ul class="subnav fl">
	...
	<div class="list_model">
		<div class="list_title clearfix">
			...
			<a href="${pageContext.request.contextPath}/goods1/showall?pageNum=1&pageSize=8" class="goods_more fr" id="fruit_more">查看更多 ></a>
		</div>
		...
		<div class="goods_con clearfix">
			...
			<script type="text/javascript">
                $("#goods").load("${pageContext.request.contextPath}/goods1/goodsall?typeid=1");
			</script>
			<%--<ul class="goods_list fl">
				<li>
					<h4><a href="#">草莓</a></h4>
					<a href="${pageContext.request.contextPath}/goods/show"><img src="${pageContext.request.contextPath}/images/goods/goods003.jpg"></a>
					<div class="prize">¥ 30.00</div>
				</li>
				<li>
					<h4><a href="#">葡萄</a></h4>
					<a href="${pageContext.request.contextPath}/goods/show"><img src="${pageContext.request.contextPath}/images/goods/goods002.jpg"></a>
					<div class="prize">¥ 5.50</div>
				</li>
				<li>
					<h4><a href="#">柠檬</a></h4>
					<a href="${pageContext.request.contextPath}/goods/show"><img src="${pageContext.request.contextPath}/images/goods/goods001.jpg"></a>
					<div class="prize">¥ 3.90</div>
				</li>
				<li>
					<h4><a href="#">奇异果</a></h4>
					<a href="${pageContext.request.contextPath}/goods/show"><img src="${pageContext.request.contextPath}/images/goods/goods012.jpg"></a>
